webpackJsonp([12],Array(565).concat([
/* 565 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__friends__ = __webpack_require__(853);
...
var FriendsPageModule = /** @class */ (function () {
    ...
    FriendsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__friends__["a" /* FriendsPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Model_User__ = __webpack_require__(357);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FriendsPage = /** @class */ (function () {
    function FriendsPage(navCtrl, navParams, matchedprovider, authprovider, notiprovider, chatprovider) {
    ...
    FriendsPage.prototype.setSearchBarInfo = function () {
        var _this = this;
        this.searching = false;
        this.searchTerm = '';
    ...
    //////////////////function : when enter search key in search bar /////////////////////////
    FriendsPage.prototype.setFilterItems = function () {
    ...
    FriendsPage.prototype.filterItems = function (searchTerm) {
        return this.friendTempList.filter(function (contactmodel) {
            return (contactmodel.username.toUpperCase().indexOf(searchTerm.toUpperCase()) > -1);
        });
    };
    FriendsPage.prototype.onSearchInput = function () {
        this.searching = true;
    };
    FriendsPage.prototype.getBlockedUserList = function () {
        var _this = this;
        this.chatprovider.getBlockedUsers().then(function (succ) {
            _this.saveFriendsInfoFromFirestore(succ);
        }).catch(function (err) {
        });
    };
    FriendsPage.prototype.getMyFriendsList = function () {
        var _this = this;
        this.matchedprovider
            .getMyfriendsList()
            .then(function (sucess) {
            _this.saveFriendsInfoFromFirestore(sucess);
        })
            .catch(function (err) {
            alert(err);
        });
    ...
    // get requested users
    FriendsPage.prototype.getRequestfriendList = function () {
        var _this = this;
        this.matchedprovider
            .getRequestList()
            .then(function (success) {
            _this.saveFriendsInfoFromFirestore(success);
        })
            .catch(function (err) {
            console.log('this is error list', err);
        });
    };
    FriendsPage.prototype.saveFriendsInfoFromFirestore = function (infoarray) {
        var _this = this;
        this.friendList = [];
        this.friendTempList = [];
        infoarray.forEach(function (element) {
            _this.authprovider.getFrindsInfoFromId(element['userkey']).then(function (result) {
                var usermodel = new __WEBPACK_IMPORTED_MODULE_7__Model_User__["a" /* User */]();
                ...
                _this.friendList.push(usermodel);
                _this.friendTempList.push(usermodel);
            });
        });
    };
    FriendsPage.prototype.onclickCancel = function () {
        this.navCtrl.pop();
    };
    FriendsPage.prototype.onclickbutton = function (info) {
        console.log('this is infolist', info);
        var user = this.friendList[info['index']];
    ...
    FriendsPage.prototype.sendUnblockRequest = function (userkey, index) {
        var _this = this;
        this.matchedprovider.sendUnblockFriendsRequest(userkey).then(function (succ) {
            _this.friendList.splice(index, 1);
            _this.friendTempList.splice(index, 1);
        }).catch(function (er) {
            alert(er);
        });
    };
    FriendsPage.prototype.sendRemoveRequest = function (userkey, index) {
        var _this = this;
        this.matchedprovider.sendRemoveFriendsRequest(userkey).then(function (success) {
            _this.friendList.splice(index, 1);
            _this.friendTempList.splice(index, 1);
    ...
    ////////////////// send accept request /////////////////////////
    FriendsPage.prototype.sendAcceptRequest = function (userkey, index) {
        var _this = this;
        this.matchedprovider
            .sendAcceptRequest(userkey)
            .then(function (success) {
            ////////////////////////send notification////////////
            var content = "has added you as a friend. Start swiping to find a place to go.";
            _this.notiprovider.sendFriendRequest("Good News", userkey, content);
            _this.friendList.splice(index, 1);
            _this.friendTempList.splice(index, 1);
        })
            .catch(function (err) { });
    ...
    FriendsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["Component"])({
            selector: 'page-friends',template:/*ion-inline-start:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/friends/friends.html"*/'<!--\n  Generated template for the FriendsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-toolbar   text-center color="textcolor">\n\n    <ion-title>\n     {{kind | uppercase}}\n    </ion-title>\n\n    <ion-buttons right>\n      <button  ion-button icon-only (click)="onclickCancel()">\n        <img  color="divider" src="assets/img/cancel_setting.png">\n      </button>\n    </ion-buttons>\n\n  </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content class="content">\n  \n  <div *ngIf="searching" class="spinner-container">\n    <ion-spinner name="bubbles">Loading</ion-spinner>\n  </div>\n\n  \n  <ion-searchbar [(ngModel)]="searchTerm" [formControl]="searchControl" (ionInput)="onSearchInput()" class="searchbar" placeholder="Search by name or username">\n\n  </ion-searchbar>\n\n  <ion-list>\n      <friendsitem *ngFor="let item of friendList; let i = index;" [data]="item" [index]="i" [kind]="kind" (onClickButtons)="onclickbutton($event)"></friendsitem>  \n  </ion-list>\n  \n\n</ion-content>\n'/*ion-inline-end:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/friends/friends.html"*/
        }),
