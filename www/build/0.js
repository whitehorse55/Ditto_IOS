webpackJsonp([0],Array(586).concat([
/* 586 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__welcome__ = __webpack_require__(877);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(602);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_contacts__ = __webpack_require__(845);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_ContactModel__ = __webpack_require__(846);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_forms__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_debounceTime__ = __webpack_require__(878);
...
var WelcomePage = /** @class */ (function () {
    function WelcomePage(navCtrl, navParams, contacts, loadingCtrl, sms, toastCtrl, plt, authprovider, alertCtrl, matchedProvider, localstorageprovider) {
        ...
        this.data_welcome = {
            ...
            title: 'Hey There!',
            description: 'Ditto is for hanging out with  your friends. Try inviting a few!',
            welcomebutton: 'OK'
        };
    ...
    WelcomePage.prototype.ionViewDidLoad = function () {
        var _this = this;
        var fromSetting = this.navParams.get('kind');
        console.log('====================================');
        ...
        setTimeout(function () {
            if (fromSetting == 'find') {
                _this.isFlag = true;
                _this.isFromSetting = true;
                _this.getContactListFromSetting();
            }
        }, 0);
    };
    WelcomePage.prototype.getContactListFromSetting = function () {
        var _this = this;
        this.searchTerm = '';
        ...
        var countrycode = this.localstorageprovider.getUserinfo()['countrycode'];
        this.getContactInfo(countrycode);
    };
    WelcomePage.prototype.getAllUsersUsingApp = function () {
        var _this = this;
        this.usinguserarray = [];
        this.matchedProvider
            ...
            _this.usinguserphonearray = suceess;
            suceess.forEach(function (element) {
                var contactmodel = new __WEBPACK_IMPORTED_MODULE_5__Model_ContactModel__["a" /* ContactModel */]();
                ...
                var array = _this.setInvitedUserStatus(element['phonenumber']);
                if (array.length > 0) {
            ...
            console.log('this is usinguserarray', _this.usinguserarray);
        })
            .catch(function (error) {
            _this.usinguserphonearray = [];
        });
    };
    ////////////////function  : check friends list from firebase/////////
    WelcomePage.prototype.getInvitedFriends = function () {
        var _this = this;
        ...
        this.authprovider
            ...
            result.forEach(function (element) {
                _this.authprovider
                    ...
                    .then(function (success) {
                    _this.invitedUserArray.push(success[0]['phonenumber']);
                    if (_this.invitedUserArray.length > 0) {
                        _this.hasInvitedUser = true;
                    }
                });
            });
            _this.getAllUsersUsingApp();
            console.log('this', _this.invitedUserArray);
        })
            .catch(function (error) {
            // this.loading.dismiss();
    ...
    //////////////////function : when enter search key in search bar /////////////////////////
    WelcomePage.prototype.setFilterItems = function () {
    ...
    /////////////////function : get search result array fromm search key///////////////////
    WelcomePage.prototype.filterItems = function (searchTerm) {
        return this.contactTempList.filter(function (contactmodel) {
            return (contactmodel.displayName
                .toUpperCase()
                .indexOf(searchTerm.toUpperCase()) > -1);
        });
    };
    WelcomePage.prototype.onclickbuttons = function (data) {
        var _this = this;
        this.showLoading();
        setTimeout(function () {
            _this.loading.dismiss();
            if (data == 'welcome') {
                _this.searchTerm = '';
                _this.searchControl.valueChanges.debounceTime(700).subscribe(function (search) {
                    _this.searching = false;
                    _this.setFilterItems();
                });
                var countrycode = _this.localstorageprovider.getUserinfo()['countrycode'];
                console.log('this is countrycode', countrycode);
                _this.getContactInfo(countrycode);
            }
        }, 5000);
    };
    //////////////////if platform is ios ////////////////
    WelcomePage.prototype.getContactInfo = function (code) {
        var _this = this;
        this.searching = false;
        this.isFlag = true;
        var options = {
        ...
        this.contacts
            ...
            res.forEach(function (element) {
                ...
                if (phonenumbers != null) {
                    ...
                    var isHasApp = _this.checkUserHasApp(contactmodel.phoneNumbers);
                    if (isHasApp) {
                        contactmodel.isHasApp = true;
                    }
                    else {
                ...
                _this.contactTempList.push(contactmodel);
                _this.contactList.push(contactmodel);
                _this.contactListOnly.push(contactmodel);
            });
            var firebasearray = _this.compareInvitedArrayandAllUsers();
            if (firebasearray.length > 0) {
                _this.contactTempList = _this.contactTempList.concat(firebasearray);
            }
            /////////////////////////array sorting/////////////////////////////
            _this.contactList.sort(_this.sortStrings).sort(_this.sortInviteStyles);
            _this.contactListOnly
                .sort(_this.sortStrings)
                .sort(_this.sortInviteStyles);
            _this.contactTempList
                .sort(_this.sortStrings)
                .sort(_this.sortInviteStyles);
            _this.loading.dismiss();
    ...
    WelcomePage.prototype.compareInvitedArrayandAllUsers = function () {
        var _this = this;
        var compareArray = this.usinguserarray.filter(function (item) { return _this.invitedUserArray.indexOf(item['phoneNumbers']) < 0; });
        return compareArray;
    };
    // filter invited member in invitedarray
    WelcomePage.prototype.setInvitedUserStatus = function (number) {
        console.log('this is contact number', number, this.invitedUserArray);
        return this.invitedUserArray.filter(function (elem) { return elem == number; });
    };
    WelcomePage.prototype.sortInviteStyles = function (a, b) {
        return a.isHasApp - b.isHasApp;
    };
    /////////////////// sort alphabeta order/////////////////
    WelcomePage.prototype.sortStrings = function (a, b) {
        // a = a.toLowerCase();
        // b = b.toLowerCase();
    ...
    WelcomePage.prototype.checkUserHasApp = function (phonenumber) {
        if (this.usinguserphonearray.length != 0) {
            var status_2 = this.usinguserphonearray.filter(function (item) { return item['phoneNumbers'] === phonenumber; });
    ...
    WelcomePage.prototype.onclickAddButton = function (phoneNumber, index) {
        var _this = this;
        this.showLoading();
        this.authprovider
            ...
            _this.authprovider
                ...
                .then(function (res) {
                _this.loading.dismiss();
                _this.changeOneitemStatus(phoneNumber, index);
            })
                .catch(function (error) {
            ...
            _this.loading.dismiss();
            _this.sendSms(phoneNumber, index);
        });
    };
    ///send SMS message if users not registred yet
    WelcomePage.prototype.sendSms = function (phoneNumber, index) {
        var _this = this;
        var options = {
        ...
        var message = 'Let’s use Ditto to find places to hang out. Download it here: http://dittochat.com/download';
        this.sms
    ...
    WelcomePage.prototype.onclickOkbutton = function () {
        console.log('====================================');
        console.log();
        console.log('====================================');
        this.navCtrl.setRoot('WelcomeinvitePage', { data: 'noskip' });
    };
    WelcomePage.prototype.onclickbackbutton = function () {
        this.navCtrl.pop();
    };
    //////////////////
    WelcomePage.prototype.changeOneitemStatus = function (number, index) {
        this.contactList.find(function (item) { return item.phoneNumbers == number; }).isInvited = true;
        this.contactTempList.find(function (item) { return item.phoneNumbers == number; }).isInvited = true;
        this.loading.dismiss();
    };
    ...
    /////////////////// show toast function////////////////////
    WelcomePage.prototype.notify = function (message) {
