webpackJsonp([11],Array(568).concat([
/* 568 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InviataionDetailPageModule", function() { return InviataionDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_components_module__ = __webpack_require__(602);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__inviataion_detail__ = __webpack_require__(856);
...
var InviataionDetailPageModule = /** @class */ (function () {
    function InviataionDetailPageModule() {
    }
    InviataionDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__inviataion_detail__["a" /* InviataionDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__inviataion_detail__["a" /* InviataionDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_0__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], InviataionDetailPageModule);
    return InviataionDetailPageModule;
}());

//# sourceMappingURL=inviataion-detail.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InviataionDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_Utils_alert_service__ = __webpack_require__(323);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_sms_sms__ = __webpack_require__(190);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_group_group__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Model_PlaceModel__ = __webpack_require__(600);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_chatprovider_chatprovider__ = __webpack_require__(108);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var InviataionDetailPage = /** @class */ (function () {
    function InviataionDetailPage(navCtrl, navParams, groupprovider, loadingCtrl, toastCtrl, sms, matchprovider, authprovider, notifprovider, chatprovider, alertService) {
    ...
    InviataionDetailPage.prototype.getImageData = function (imagedata) {
        console.log("this is image data", imagedata);
        this.passCredential.myphoto.push(imagedata);
    };
    InviataionDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad InviataionDetailPage');
    };
    InviataionDetailPage.prototype.onclickinvitebutton = function () {
        var _this = this;
        this.showLoading();
        ...
        // }else{
        this.generatePassData().then(function (res) {
            console.log("clicked===<>", res);
            if (_this.checkedArrayInfo.length == 1) {
                if (_this.checkedArrayInfo[0]['groupid']) {
                    _this.sendGroupInvite();
                }
                else {
                    _this.sendRequestToUser();
                }
            }
            else {
                if (_this.checkedArrayInfo[0]['groupid']) {
    ...
    InviataionDetailPage.prototype.validateForm = function () {
    };
    //////////////////////////////////////////// generate group /////////////////////////////////////
    InviataionDetailPage.prototype.generateGroup = function () {
        var _this = this;
        console.log("this is message ==>", this.passdata, this.checkedArrayInfo);
        var message = 'I’d like to invite you to ' + this.passdata['place_name'] + "-" + this.passdata['place_address'] + '. Accept the invite on Ditto http://dittochat.com/download';
        this.groupprovider.generateGroup(this.passdata, this.checkedArrayInfo).then(function (res) {
            _this.loading.dismiss();
            _this.chatprovider.addMeetingWhenGroup(_this.passdata['place_name'] + "-" + _this.passdata['place_address'], _this.passdata['place_photo'], "meeting", _this.passdata['place_time'], _this.passdata['place_time'], res['groupid']).then(function (result) {
                if (res.length > 0) {
    ...
    // 1 : 1 user invite 
    InviataionDetailPage.prototype.sendRequestToUser = function () {
        var contactmodel = this.checkedArrayInfo[0];
    ...
    InviataionDetailPage.prototype.sendAutoMatchRquest = function (contactmodel) {
        var _this = this;
    ...
    InviataionDetailPage.prototype.automatch = function (contactmodel) {
        var _this = this;
                            ...
                            _this.matchprovider.saveMatchedUsersList(contactmodel['id']).then(function (ss) {
                                _this.matchprovider.saveMatchedOtherUsersList(contactmodel['id']).then(function (succ) {
                                    _this.authprovider.getMyFriendsList(contactmodel['id']).then(function (resu) {
                                        _this.chatprovider.addMeeting(_this.passdata['place_name'] + "-" + _this.passdata['place_address'], _this.passdata['place_photo'], contactmodel['id'], "meeting", _this.passdata['place_time'], _this.passdata['place_time']).then(function (suc) {
                                            _this.openChatTab();
                                            _this.loading.dismiss();
                                            _this.notify('Sent');
                                        }).catch(function (er) {
    ...
    InviataionDetailPage.prototype.sendFriendRequestWithMatch = function (model) {
        var _this = this;
    ...
    InviataionDetailPage.prototype.sendTextMessage = function (phoneNumber) {
        var _this = this;
        var message = 'I’d like to invite you to ' + this.passdata['place_name'] + "-" + this.passdata['place_address'] + '. Accept the invite on Ditto http://dittochat.com/download';
    ...
    InviataionDetailPage.prototype.generatePassData = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            console.log("this is photos info", _this.passCredential.myphoto);
            if (_this.passCredential.myphoto.length == 0) {
                var yelpmodel = new __WEBPACK_IMPORTED_MODULE_5__Model_PlaceModel__["b" /* YelpModel */]();
                yelpmodel.place_id = _this.passCredential.mydetails;
                yelpmodel.place_photo = "";
                yelpmodel.place_time = _this.passCredential.mydate;
                yelpmodel.place_name = _this.passCredential.mydetails;
                yelpmodel.place_address = _this.passCredential.myaddress;
                _this.passdata = yelpmodel;
                resolve(yelpmodel);
            }
            else {
                _this.authprovider.saveImageDataToStorage(_this.passCredential.myphoto).then(function (result) {
    ...
    InviataionDetailPage.prototype.sendGroupInvite = function () {
        var _this = this;
        console.log("this is message ==>", this.passdata, this.checkedArrayInfo);
        this.groupprovider.saveGroupInfodata(this.passdata, this.checkedArrayInfo, "newInvite").then(function (suc) {
    ...
    InviataionDetailPage.prototype.showLoading = function () {
    ...
    InviataionDetailPage.prototype.notify = function (message) {
    ...
    InviataionDetailPage.prototype.openChatTab = function () {
        // this.navCtrl.setRoot('BottomtabbarPage', { opentab: 3 })
        this.navCtrl.pop();
        this.navCtrl.parent.select(3);
    };
    InviataionDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_6__angular_core__["Component"])({
            selector: 'page-inviataion-detail',template:/*ion-inline-start:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/inviataion-detail/inviataion-detail.html"*/'<!--\n  Generated template for the InviataionDetailPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar text-center>\n    <ion-title>Invitation Details</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="content" >\n    <form (ngSubmit)="onclickinvitebutton()" #registerForm="ngForm">\n        <ion-item  class="myitem">\n            <ion-input  item-left placeholder="Details" name="mydetails"  [(ngModel)]="passCredential.mydetails" required></ion-input>\n            <imagegallery  item-end (sendImageData)="getImageData($event)"></imagegallery>    \n        </ion-item>\n    \n        <ion-item class="myitem">\n          <ion-input placeholder="Location/Address" name="myaddress" [(ngModel)]="passCredential.myaddress" required></ion-input>\n        </ion-item>\n    \n        <ion-item class="myitem">\n          <ion-label>Time/Date</ion-label>\n          <ion-datetime displayFormat="YY/MMM/DD/DDDD hh/mm A" name="mydate" [(ngModel)]="passCredential.mydate" required></ion-datetime>\n        </ion-item>\n    \n        <button class="mybutton" ion-button type="submit" [disabled]="!registerForm.form.valid">\n          Send Invite\n        </button>\n    </form>\n    \n    \n</ion-content>\n\n'/*ion-inline-end:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/inviataion-detail/inviataion-detail.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_7_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_7_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_4__providers_group_group__["a" /* GroupProvider */],
            __WEBPACK_IMPORTED_MODULE_7_ionic_angular__["j" /* LoadingController */],
            __WEBPACK_IMPORTED_MODULE_7_ionic_angular__["p" /* ToastController */],
            __WEBPACK_IMPORTED_MODULE_1__providers_sms_sms__["a" /* SmsProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_9__providers_chatprovider_chatprovider__["a" /* ChatproviderProvider */],
            __WEBPACK_IMPORTED_MODULE_0__providers_Utils_alert_service__["a" /* AlertService */]])
    ], InviataionDetailPage);
    return InviataionDetailPage;
}());

//# sourceMappingURL=inviataion-detail.js.map
