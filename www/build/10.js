webpackJsonp([10],Array(571).concat([
/* 571 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MainDetailPageModule", function() { return MainDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__main_detail__ = __webpack_require__(859);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(602);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic2_rating__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pipes_pipes_module__ = __webpack_require__(348);
...
var MainDetailPageModule = /** @class */ (function () {
    function MainDetailPageModule() {
    }
    MainDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__main_detail__["a" /* MainDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__main_detail__["a" /* MainDetailPage */]),
    ...
    ], MainDetailPageModule);
    return MainDetailPageModule;
}());

//# sourceMappingURL=main-detail.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MainDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_yelp_yelp__ = __webpack_require__(324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_in_app_browser__ = __webpack_require__(349);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var MainDetailPage = /** @class */ (function () {
    // slides=['assets/img/stadium.jpg','assets/img/stadium-2.jpg','assets/img/stadium-3.png']
    function MainDetailPage(navCtrl, platform, navParams, yelpservice, lab) {
    ...
    MainDetailPage.prototype.ionViewWillEnter = function () {
        // this.showBanner();
        this.slider.centeredSlides = true;
    };
    MainDetailPage.prototype.onclickBackbutton = function () {
        this.navCtrl.pop();
    };
    MainDetailPage.prototype.getDetailYelpData = function (place_id) {
        var _this = this;
        this.yelpservice.getYelpDetailInfo(place_id).then(function (result) {
            _this.detail_info = result;
            _this.detail_address = _this.detail_info.location.display_address;
            _this.detail_city = _this.detail_info.location.city;
            _this.detail_category = _this.detail_info['categories'];
            console.log("detail info", _this.detail_info.location.display_address);
        }).catch(function (err) {
        });
    };
    MainDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad MainDetailPage');
    };
    MainDetailPage.prototype.onSlideChanged = function () {
        this.slideIndex = this.slider.getActiveIndex();
        console.log('Slide changed! Current index is', this.slideIndex);
    };
    MainDetailPage.prototype.onclickyelpbutton = function (url) {
        this.lab.create(url);
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('slider'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* Slides */])
    ], MainDetailPage.prototype, "slider", void 0);
    MainDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-main-detail',template:/*ion-inline-start:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/main-detail/main-detail.html"*/'<ion-content class="content">\n\n \n\n     <div class="top_images">\n        <ion-slides *ngIf="detail_info.photos && detail_info.photos.length" #slider pager="true"  (ionSlideWillChange)="onSlideChanged()">\n          <ion-slide *ngFor="let slide of detail_info.photos" class="slide-background">\n            <button color="extralight" clear full class="back_button" ion-button (click)="onclickBackbutton()">\n              <ion-icon ios="ios-arrow-round-back" md="md-arrow-round-back"></ion-icon>\n            </button> \n            <img src="{{slide}}"/>\n          </ion-slide>\n        </ion-slides>\n     </div>\n\n     <div>\n        <ion-list>\n            <ion-item>\n                <div class="part_name">\n                  <p>{{detail_info.name}} </p>\n                </div>\n      \n                <div class="part_more">\n                  <button (click)="onclickyelpbutton(detail_info.url)" ion-button clear>\n                    <img src="assets/img/logo_yelp.png"/>\n                  </button>\n                </div>\n              </ion-item>\n      \n              <ion-item>\n      \n                <div class="part_rating">\n                    <!-- <rating [(ngModel)]="detail_info.rating" readOnly="false" max="5" emptyStarIconName="star-outline" halfStarIconName="star-half"\n                    starIconName="star" nullable="false"></rating> -->\n                    <img  *ngIf="detail_info.rating == 0" src="assets/img/regular_0.png">\n                    <img  *ngIf="detail_info.rating < 1" src="assets/img/regular_1.png">\n                    <img  *ngIf="detail_info.rating > 1.5 && detail_info.rating < 2" src="assets/img/regular_1_half.png">\n                    <img  *ngIf="detail_info.rating == 2" src="assets/img/regular_2.png">\n                    <img  *ngIf="detail_info.rating > 2 && detail_info.rating < 3" src="assets/img/regular_2_half.png">\n                    <img  *ngIf="detail_info.rating == 3" src="assets/img/regular_3.png">\n                    <img  *ngIf="detail_info.rating > 3 && detail_info.rating < 4" src="assets/img/regular_3_half.png">\n                    <img  *ngIf="detail_info.rating == 4" src="assets/img/regular_4.png">\n                    <img  *ngIf="detail_info.rating > 4 && detail_info.rating < 5" src="assets/img/regular_4_half.png">\n                    <img  *ngIf="detail_info.rating == 5" src="assets/img/regular_5.png">\n                </div>\n      \n                <div class="part_reviews">\n                  <p>{{detail_info.review_count}} reviews</p>\n                </div>\n      \n              </ion-item>\n      \n              <ion-item>\n      \n                <div class="part_price">\n                  <p>{{detail_info.price}}</p>\n                </div>\n      \n                <div class="part_address">\n                    <p style="display: inline-block;">{{detail_category | removecommand}} </p>\n                    <p>{{detail_city}}</p>\n                </div>\n      \n              </ion-item>\n\n              <ion-item>\n                  <p class="font_bold">Address</p>\n                  <p *ngFor="let myaddress of detail_address" class="font_address">{{myaddress}}</p>\n              </ion-item>\n\n              \n              <ion-item>\n                  <p class="font_bold">phone</p>\n                  <p class="font_address">{{detail_info.phone}}</p>\n              </ion-item>\n\n              <ion-item>\n                <p class="font_bold">More</p>\n                <p (click)="onclickyelpbutton(detail_info.url)" class="font_address">view more on Yelp</p>\n              </ion-item>\n        </ion-list>\n     </div>\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/main-detail/main-detail.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_yelp_yelp__["a" /* YelpProvider */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_in_app_browser__["a" /* InAppBrowser */]])
    ], MainDetailPage);
    return MainDetailPage;
}());

//# sourceMappingURL=main-detail.js.map
