webpackJsonp([1],Array(573).concat([
/* 573 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__match__ = __webpack_require__(861);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_notification_notification__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_admob_free__ = __webpack_require__(862);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MatchPage = /** @class */ (function () {
    function MatchPage(navCtrl, navParams, authProvider, matchProvider, localstorageprovider, notifprovider, admob, platform) {
    ...
    MatchPage.prototype.ionViewDidLoad = function () {
        ...
        var userinfos = this.navParams.get('userinfos');
        var placeinfos = this.navParams.get('placeinfo');
    ...
    MatchPage.prototype.showBanner = function () {
        var _this = this;
        var key;
        if (this.platform.is('android')) {
    ...
    MatchPage.prototype.ionViewWillLeave = function () {
        this.admob.banner.hide();
    };
    MatchPage.prototype.saveMatcheduser = function (info, placeinfo) {
        var _this = this;
        this.matchProvider.saveMatchedUsers(info, placeinfo).then(function (sucee) {
            _this.matchProvider.saveMatchedUsersList(info).then(function (succ) {
                info.forEach(function (element) {
                    console.log('elemetnsts====================================');
                    console.log(element);
                    console.log('====================================');
                    _this.matchProvider.saveMatchedOtherUsersList(element).then(function (res) {
                    });
                });
    ...
    MatchPage.prototype.getUserInfosFromKeys = function (userinfo, placeinfo) {
        var _this = this;
        var nameArray = 'You , ';
        var photoArray = [];
        var tempNameArray = "";
        ...
        userinfo.forEach(function (element) {
            _this.authProvider
                ...
                .then(function (success) {
                i++;
                _this.userInfoArray.push(success[0]);
                ...
                if (i == userinfo.length) {
                    ...
                    _this.notifprovider.sendMatchRequest(userinfo, tempNameArray, placeinfo['place_name']);
                    _this.generateDataForComponent(nameArray, photoArray, placeinfo);
                }
                else {
                    nameArray = nameArray + success[0]['username'] + ",";
                    tempNameArray = tempNameArray + success[0]['username'] + ",";
    ...
    MatchPage.prototype.generateDataForComponent = function (names, photos, place) {
    ...
    MatchPage.prototype.onclickbuttons = function (key) {
        if (key == 'back') {
            this.navCtrl.pop();
        }
        else if (key == 'chat') {
    ...
    MatchPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'page-match',template:/*ion-inline-start:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/match/match.html"*/'\n<ion-content padding class="content" overflow-scroll="true">\n  <matched [data]="data" (onClickSomethingUp)="onclickbuttons($event)" ></matched>\n</ion-content>\n'/*ion-inline-end:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/match/match.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_observable_fromEvent__ = __webpack_require__(863);
...
var AdMobFree = (function (_super) {
    ...
    AdMobFree.prototype.on = function (event) {
        return Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_observable_fromEvent__["fromEvent"])(document, event);
    };
...
var AdMobFreeBanner = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__ionic_native_core__["a" /* Cordova */])({ otherPromise: true }),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
