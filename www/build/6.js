webpackJsonp([6],Array(581).concat([
/* 581 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setting__ = __webpack_require__(872);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_facebook__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_google_plus__ = __webpack_require__(194);
...
var SettingPage = /** @class */ (function () {
    function SettingPage(navCtrl, navParams, localstorage, platform, fb, googleplus, authprovider, admobprovider, myapp) {
    ...
    // }
    SettingPage.prototype.getMyInfo = function () {
        var myinfo = this.localstorage.getUserinfo();
        this.myinfos = myinfo;
        console.log('ionViewDidLoad SettingPage', this.myinfos);
    };
    SettingPage.prototype.onclickCancel = function () {
        this.navCtrl.pop();
    };
    SettingPage.prototype.getUserStatus = function () {
        var _this = this;
        var myid = this.localstorage.getUserinfo()['id'];
        this.authprovider.getUserStatus(myid).then(function (res) {
            console.log("this is result", res);
            if (res[0]['status']) {
                _this.isToggle = res[0]['status'];
            }
            else {
    ...
    SettingPage.prototype.updateItem = function (item) {
        this.authprovider.updateUserStatus(item.checked).then(function (res) {
        }).catch(function (e) {
        });
    };
    SettingPage.prototype.onclickLogout = function () {
        var _this = this;
        this.fb.logout();
        this.googleplus.logout();
        this.localstorage.clearLocalstorage();
        this.admobprovider.removeAdmob().then(function (res) {
            _this.myapp.getRootNav().setRoot('LoginPage', { type: "logout" });
        });
    };
    SettingPage.prototype.onclickitem = function (kind) {
        if (kind == 'fr') {
    ...
    SettingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'page-setting',template:/*ion-inline-start:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/setting/setting.html"*/'\n<ion-header>\n  <custommenubar [data]="data_menubar"></custommenubar>\n</ion-header>\n\n<ion-content class="content">\n\n  <ion-item no-lines>\n\n    <div item-left>\n      <p style="font-weight: bold; font-size: 16pt;">{{myinfos.username}}</p>\n      <p style="color : #22242a;font-size: 12pt;">{{myinfos.email}}</p>\n    </div>\n\n    <img item-right src="{{myinfos.photoUrl}}">\n\n  </ion-item>\n\n  <ion-item no-lines class="top_item" (click)="onclickitem(\'fr\')">\n    <p>My Friends</p>\n  </ion-item>\n\n  <ion-item no-lines (click)="onclickitem(\'re\')">\n    <p>Requests</p>\n  </ion-item>\n\n  <ion-item no-lines (click)="onclickitem(\'fi\')">\n    <p>Find & Invite Friends</p>\n  </ion-item>\n\n  <ion-item no-lines (click)="onclickitem(\'in\')">\n    <p>Choose interests and location</p>\n  </ion-item>\n\n  <ion-item no-lines (click)="onclickitem(\'block\')">\n    <p>Blcked Users</p>\n  </ion-item>\n\n  <ion-item no-lines (click)="onclickitem(\'private\')">\n\n    <div item-left>\n      <p>Private Account</p>\n    </div>\n\n    <ion-toggle style="width : 50px;" item-right [(ngModel)]="isToggle" (ionChange)="updateItem($event)"></ion-toggle>\n  </ion-item>\n\n  <button class="btn_logout" (click)="onclickLogout()" ion-button>Log Out</button>\n\n</ion-content>'/*ion-inline-end:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/setting/setting.html"*/
        }),
