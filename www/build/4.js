webpackJsonp([4],Array(563).concat([
/* 563 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_geolocatino_geolocatino__ = __webpack_require__(322);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Model_ChatModel__ = __webpack_require__(847);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_chatprovider_chatprovider__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_yelp_yelp__ = __webpack_require__(324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_group_group__ = __webpack_require__(351);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChattingPage = /** @class */ (function () {
    function ChattingPage(navCtrl, navParams, authprovider, loadingCtrl, localstorageprovider, chatprovider, platform, modalCtrl, geolocationprovider, yelpprovider, groupprovider, admobprovider) {
    ...
    ChattingPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.getGroupData();
        this.isloadedView = false;
        setTimeout(function () {
            _this.admobprovider.showadmob(50);
        }, 2000);
    };
    ...
    ChattingPage.prototype.getChatUsers = function () {
        var _this = this;
        this.showLoading();
        this.chatprovider
            .getChatUsers()
            .then(function (suce) {
            _this.invitedUserArray = [];
            suce.forEach(function (element) {
                var chatmodel = new __WEBPACK_IMPORTED_MODULE_2__Model_ChatModel__["a" /* ChatModel */]();
                _this.chatprovider.getAcceptedChatUsers(element).then(function (sucess) {
                    if (sucess.length > 0) {
                        _this.chatprovider
                            ...
                            _this.chatprovider
                                ...
                                _this.yelpprovider.getYelpDetailInfo(suce[0]['placeid']).then(function (res) {
                            ...
                            _this.chatprovider.getLastMessage(succ[0]['id']).then(function (succe) {
                                chatmodel.lastmessage = succe;
                            }).catch(function (err) {
                                chatmodel.lastmessage = "";
                            });
                            _this.chatprovider.getMettingDate(succ[0]['id']).then(function (succ) {
                            ...
                            _this.invitedUserArray.push(chatmodel);
                            _this.isloadedView = true;
                            console.log("this is inveti", _this.invitedUserArray);
                        })
                            .catch(function (er) {
                            _this.loading.dismiss();
                            _this.isloadedView = true;
    ...
    ChattingPage.prototype.onclickGroupItem = function (item) {
        console.log("this is group info data", item);
        var chatamodel = new __WEBPACK_IMPORTED_MODULE_2__Model_ChatModel__["a" /* ChatModel */]();
        chatamodel.userplaces = item['places'];
        chatamodel.groupid = item['groupid'];
        this.navCtrl.push('GroupchatroomPage', { data: chatamodel });
    };
    ChattingPage.prototype.onclickItems = function (info) {
        var _this = this;
        console.log('this is item click', info);
        if (info['type'] == 'istime') {
            var data = this.invitedUserArray[info['index']];
            this.chatprovider.getMettingDateWhenDate(data['userid']).then(function (succ) {
                console.log("sfusfefefe", succ);
                _this.modalCtrl
                    .create('MatchdatePage', { data: succ }, { cssClass: 'inset-modal-match' })
                    .present();
            });
        }
        else {
    ...
    ChattingPage.prototype.showLoading = function () {
    ...
    ChattingPage.prototype.onclickbutton = function (info) {
        this.navCtrl.push('WelcomePage', { kind: 'find' });
    };
    ChattingPage.prototype.onclickHomeButton = function () {
        console.log('====================================');
    ...
    ChattingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_6__angular_core__["Component"])({
            selector: 'page-chatting',template:/*ion-inline-start:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/chatting/chatting.html"*/'\n<ion-header>\n  <custommenubar [data]="data_menubar"></custommenubar>\n</ion-header>\n\n<ion-content class="content">\n\n  <emptychat *ngIf="isloadedView && invitedUserArray.length == 0" (onclickMenubar)="onclickbutton($event)"></emptychat>\n  <ion-list>\n    <groupitem *ngIf="groupArray.length > 0" [data]="groupArray" [title]="\'chat\'" (onClickItems)="onclickGroupItem($event)" ></groupitem>\n    <chatitem *ngFor="let item of invitedUserArray; let i = index;" [index]="i" [data]="item" (onclickItem)="onclickItems($event)" ></chatitem>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/chatting/chatting.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_7_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_chatprovider_chatprovider__["a" /* ChatproviderProvider */],
            __WEBPACK_IMPORTED_MODULE_7_ionic_angular__["n" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_7_ionic_angular__["k" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1__providers_geolocatino_geolocatino__["a" /* GeolocatinoProvider */],
            __WEBPACK_IMPORTED_MODULE_8__providers_yelp_yelp__["a" /* YelpProvider */],
            __WEBPACK_IMPORTED_MODULE_9__providers_group_group__["a" /* GroupProvider */],
