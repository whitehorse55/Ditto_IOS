webpackJsonp([2],Array(576).concat([
/* 576 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewInvitePageModule", function() { return NewInvitePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pipes_pipes_module__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__new_invite__ = __webpack_require__(867);
...
var NewInvitePageModule = /** @class */ (function () {
    function NewInvitePageModule() {
    }
    NewInvitePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__new_invite__["a" /* NewInvitePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__new_invite__["a" /* NewInvitePage */]),
    ...
    return NewInvitePageModule;
}());

//# sourceMappingURL=new-invite.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NewInvitePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model_ContactModel__ = __webpack_require__(846);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_localstorage_localstorage__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_matched_matched__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_group_group__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_forms__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_contacts__ = __webpack_require__(845);
 ...
 */
var NewInvitePage = /** @class */ (function () {
    function NewInvitePage(navCtrl, groupprovider, matchprovider, localstorageprovider, authprovider, platform, loadingCtrl, sms, smstext, notifprovider, events, contacts, toastCtrl, navParams) {
        var _this = this;
    ...
    NewInvitePage.prototype.ionViewWillEnter = function () {
        this.showLoading();
        // temp test
        this.getMyGroupInfo();
    };
    NewInvitePage.prototype.getMyGroupInfo = function () {
        var _this = this;
        this.groupprovider
            .getMygroups()
            .then(function (res) {
    ...
    NewInvitePage.prototype.getFriendsListInfo = function () {
        var _this = this;
    ...
    NewInvitePage.prototype.getUsingAppUsersInfo = function () {
        var _this = this;
        this.matchprovider
            ...
            for (var i = 0; i < suceess.length; i++) {
                var contactmodel = new __WEBPACK_IMPORTED_MODULE_0__Model_ContactModel__["a" /* ContactModel */]();
    ...
    NewInvitePage.prototype.sortStrings = function (a, b) {
    ...
    NewInvitePage.prototype.onSearchInput = function () {
        this.searching = true;
    };
    //////////////////function : when enter search key in search bar /////////////////////////
    NewInvitePage.prototype.setFilterItems = function () {
        if (this.searchTerm == '') {
    ...
    /////////////////function : get search result array fromm search key///////////////////
    NewInvitePage.prototype.filterItems = function (filterarray, searchTerm) {
    ...
    NewInvitePage.prototype.getPhoneContactInfo = function (onlinearray, onlinetemparray) {
        var _this = this;
        this.searching = false;
        this.showLoading();
        var options = {
    ...
    NewInvitePage.prototype.checkUserHasApp = function (phonenumber) {
        if (this.usinguserarray.length != 0) {
            var status_2 = this.usinguserarray.filter(function (item) { return item['phoneNumbers'] === phonenumber; });
    ...
    NewInvitePage.prototype.setInvitedUserStatus = function (number) {
        return this.friendArray.filter(function (elem) { return elem === number; });
    };
    ////////////// function : show progress view///////////////////
    NewInvitePage.prototype.showLoading = function () {
    ...
    NewInvitePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad NewInvitePage');
    };
    // when click group checkbox button
    NewInvitePage.prototype.onclickGroupCheckbox = function (items, type) {
        var _this = this;
    ...
    NewInvitePage.prototype.uncheckedAll = function () {
        this.groupListArray
            .filter(function (elem) { return elem.isChecked == true; })
            .forEach(function (element) {
            element.isChecked = false;
        });
        this.uncheckedAllWhenGroup();
    };
    NewInvitePage.prototype.uncheckedAllWhenGroup = function () {
    ...
    NewInvitePage.prototype.onclickCheckbox = function (items, type) {
        if (this.isGroup) {
            this.isGroup = false;
            this.checkedArray = [];
        }
        ...
        if (items['isChecked'] == true) {
            if (this.checkedArray.length == 0) {
                ...
                var status_3 = this.checkedArray.filter(function (elem) { return elem['phoneNumbers'] == items['phoneNumbers']; });
    ...
    NewInvitePage.prototype.onclicknextbutton = function () {
        if (this.checkedArray.length == 0) {
        }
        else {
            console.log('this is checked array info========>>', this.checkedArray);
    ...
    NewInvitePage.prototype.notify = function (message) {
    ...
    NewInvitePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_10_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_10_ionic_angular__["e" /* Events */],
            __WEBPACK_IMPORTED_MODULE_8__ionic_native_contacts__["a" /* Contacts */],
            __WEBPACK_IMPORTED_MODULE_10_ionic_angular__["p" /* ToastController */],
            __WEBPACK_IMPORTED_MODULE_10_ionic_angular__["m" /* NavParams */]])
    ], NewInvitePage);
    return NewInvitePage;
}());
