webpackJsonp([3],Array(569).concat([
/* 569 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InviteplacePageModule", function() { return InviteplacePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__inviteplace__ = __webpack_require__(857);
...
var InviteplacePageModule = /** @class */ (function () {
    function InviteplacePageModule() {
    }
    InviteplacePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__inviteplace__["a" /* InviteplacePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__inviteplace__["a" /* InviteplacePage */]),
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicModule */],
                __WEBPACK_IMPORTED_MODULE_3__pipes_pipes_module__["a" /* PipesModule */],
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], InviteplacePageModule);
    return InviteplacePageModule;
}());

//# sourceMappingURL=inviteplace.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ionic_native_core__ = __webpack_require__(20);
...
var Contact = (function () {
    function Contact() {
        if (Object(__WEBPACK_IMPORTED_MODULE_0__ionic_native_core__["i" /* checkAvailability */])('navigator.contacts', 'create', 'Contacts') === true) {
    ...
    Contact.prototype.save = function () {
        var _this = this;
        return Object(__WEBPACK_IMPORTED_MODULE_0__ionic_native_core__["j" /* getPromise */])(function (resolve, reject) {
    ...
    __decorate([
        __WEBPACK_IMPORTED_MODULE_0__ionic_native_core__["f" /* InstanceProperty */],
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__ionic_native_core__["e" /* InstanceCheck */])(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Contact)
    ], Contact.prototype, "clone", null);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__ionic_native_core__["c" /* CordovaInstance */])(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
...
var Contacts = (function (_super) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__ionic_native_core__["b" /* CordovaCheck */])(),
        __metadata("design:type", Function),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InviteplacePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_contacts__ = __webpack_require__(845);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_matched_matched__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Model_ContactModel__ = __webpack_require__(846);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_sms__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_notification_notification__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_group_group__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_sms_sms__ = __webpack_require__(190);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 */
var InviteplacePage = /** @class */ (function () {
    function InviteplacePage(navCtrl, navParams, contacts, matchprovider, localstorageprovider, authprovider, platform, loadingCtrl, sms, smstext, notifprovider, groupprovider, events, toastCtrl) {
        var _this = this;
        ...
        this.searchControl = new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["a" /* FormControl */]();
        this.searching = false;
        this.searchTerm = '';
    ...
    InviteplacePage.prototype.getMyGroupInfo = function () {
        var _this = this;
        this.groupprovider.getMygroups().then(function (res) {
            console.log("this is group info data=>", res);
            _this.loading.dismiss();
            _this.groupListArray = res;
        }).catch(function (err) {
            _this.loading.dismiss();
        });
        this.getFriendsListInfo();
    };
    InviteplacePage.prototype.onclickDonebutton = function () {
        this.events.publish('dismissinvite');
        this.navCtrl.pop();
    };
    InviteplacePage.prototype.onSearchInput = function () {
        this.searching = true;
    };
    //////////////////function : when enter search key in search bar /////////////////////////
    InviteplacePage.prototype.setFilterItems = function () {
        if (this.searchTerm == '') {
    ...
    /////////////////function : get search result array fromm search key///////////////////
    InviteplacePage.prototype.filterItems = function (filterarray, searchTerm) {
        return filterarray.filter(function (contactmodel) {
            return (contactmodel.displayName.toUpperCase()
                .toUpperCase()
                .indexOf(searchTerm.toUpperCase()) > -1);
        });
    };
    InviteplacePage.prototype.getPhoneContactInfo = function (onlinearray, onlinetemparray) {
        var _this = this;
        this.searching = false;
        this.showLoading();
        var options = {
        ...
        this.contacts
            ...
            res.forEach(function (element) {
                i++;
                var contactmodel = new __WEBPACK_IMPORTED_MODULE_4__Model_ContactModel__["a" /* ContactModel */]();
                ...
                var phonenumbers = element.phoneNumbers;
                if (phonenumbers != null) {
                    var phonenospace = phonenumbers[0]['value'].replace(/\s/g, '');
                    var code = _this.localstorageprovider.getUserinfo()['countrycode'];
                    ...
                    var photoimage = element.photos;
                    if (photoimage != null) {
                        photoimage.forEach(function (photo) {
                    ...
                    var status_1 = _this.setInvitedUserStatus(contactmodel.phoneNumbers);
                    ...
                    var status_check = _this.checkUserHasApp(contactmodel.phoneNumbers);
                    var isodd = onlinearray.filter(function (elem) { return elem['phoneNumbers'] == contactmodel.phoneNumbers; });
                    if (status_check) {
                ...
                if (i == res.length) {
                    ...
                    (_a = _this.onlineArray).push.apply(_a, onlinearray.sort(_this.sortStrings));
                    (_b = _this.phoneContactArray).push.apply(_b, contactarray.sort(_this.sortStrings));
                    (_c = _this.onlineTempArray).push.apply(_c, onlinetemparray.sort(_this.sortStrings));
                    (_d = _this.phoneContactTempArray).push.apply(_d, contactTemparray.sort(_this.sortStrings));
                }
                var _a, _b, _c, _d;
            });
            _this.loading.dismiss();
    ...
    InviteplacePage.prototype.sortFriends = function (a, b) {
        return b.isInvited - a.isInvited;
    };
    InviteplacePage.prototype.sortInviteStyles = function (a, b) {
        return b.isHasApp - a.isHasApp;
    };
    /////////////////// sort alphabeta order/////////////////
    InviteplacePage.prototype.sortStrings = function (a, b) {
    ...
    InviteplacePage.prototype.onclickGroupCheckbox = function (items, type) {
        var _this = this;
        ...
        this.isGroup = true;
        var array_exist = this.checkedArray.filter(function (ele) { return ele['groupid'] == items['groupid']; });
        if (array_exist.length > 0) {
            array_exist.forEach(function (element) {
                if (element.isChecked) {
                    _this.checkedArray.splice(_this.checkedArray.indexOf(items), 1);
                }
                else {
                    _this.checkedArray.push(items);
                }
    ...
    InviteplacePage.prototype.uncheckedAll = function () {
        this.groupListArray.filter(function (elem) { return elem.isChecked == true; }).forEach(function (element) {
            element.isChecked = false;
        });
        this.uncheckedAllWhenGroup();
    };
    InviteplacePage.prototype.uncheckedAllWhenGroup = function () {
        this.onlineArray.filter(function (elem) { return elem.isChecked == true; }).forEach(function (elem) {
            elem.isChecked = false;
        });
        this.onlineTempArray.filter(function (elem) { return elem.isChecked == true; }).forEach(function (element) {
            element.isChecked = false;
        });
        this.phoneContactArray.filter(function (elem) { return elem.isChecked == true; }).forEach(function (element) {
            element.isChecked = false;
        });
        this.phoneContactTempArray.filter(function (elem) { return elem.isChecked == true; }).forEach(function (element) {
            element.isChecked = false;
        });
        this.otherListArray.filter(function (elem) { return elem.isChecked == true; }).forEach(function (element) {
            element.isChecked = false;
        });
        this.otherListTempArray.filter(function (elem) { return elem.isChecked == true; }).forEach(function (element) {
            element.isChecked = false;
        });
    };
    // function : when click checkbox buttons
    InviteplacePage.prototype.onclickCheckbox = function (items, type) {
        if (this.isGroup) {
            this.isGroup = false;
            this.checkedArray = [];
        }
        ...
        if (type == 'online') {
            var item = this.onlineArray.find(function (elem) { return elem.phoneNumbers == items['phoneNumbers']; });
            var item1 = this.onlineTempArray.find(function (elem) { return elem.phoneNumbers == items['phoneNumbers']; });
            console.log("this is online array", item, item1);
            item.isChecked = !item.isChecked;
            item1.isChecked = !item.isChecked;
        }
        else if (type == 'phone') {
            var item = this.phoneContactArray.find(function (elem) { return elem['phoneNumbers'] === items['phoneNumbers']; });
            var item1 = this.phoneContactTempArray.find(function (elem) { return elem['phoneNumbers'] === items['phoneNumbers']; });
            item.isChecked = !item.isChecked;
            item1.isChecked = !item.isChecked;
        }
        else if (type == 'other') {
            var item = this.otherListArray.find(function (elem) { return elem['phoneNumbers'] === items['phoneNumbers']; });
            var item1 = this.otherListTempArray.find(function (elem) { return elem['phoneNumbers'] === items['phoneNumbers']; });
            item.isChecked = !item.isChecked;
            item1.isChecked = !item.isChecked;
        }
        ...
        if (items['isChecked'] == true) {
            if (this.checkedArray.length == 0) {
                ...
                var status_2 = this.checkedArray.filter(function (elem) { return elem['phoneNumbers'] == items['phoneNumbers']; });
                console.log("checked list", status_2);
                if (status_2.length == 0) {
                    this.checkedArray.push(items);
                }
            }
        }
    ...
    InviteplacePage.prototype.onclickSendbutton = function () {
        this.showLoading();
        this.uncheckedAll();
    ...
    InviteplacePage.prototype.sendGroupInvite = function () {
        var _this = this;
        console.log("this is message ==>", this.passdata, this.checkedArray);
        this.groupprovider.saveGroupInfodata(this.passdata, this.checkedArray, "inviteplace").then(function (suc) {
    ...
    //////////////////////////////////////////// generate group /////////////////////////////////////
    InviteplacePage.prototype.generateGroup = function () {
        var _this = this;
        console.log("this is message ==>", this.passdata, this.checkedArray);
        var message = 'I’d like to invite you to ' + this.passdata['place_name'] + '. Accept the invite on Ditto http://dittochat.com/download';
        this.groupprovider.generateGroup(this.passdata, this.checkedArray).then(function (res) {
            _this.loading.dismiss();
            if (res.length > 0) {
                _this.sms.sendTextMessages(res['message'], message).then(function (res) {
                    _this.loading.dismiss();
                    _this.notify('Sent');
                }).catch(function (er) {
                    _this.loading.dismiss();
    ...
    // 1 : 1 user invite 
    InviteplacePage.prototype.sendRequestToUser = function () {
        var contactmodel = this.checkedArray[0];
    ...
    InviteplacePage.prototype.sendAutoMatchRquest = function (contactmodel) {
        // this.showLoading()
        var _this = this;
        this.authprovider.getUserStatus(contactmodel['id']).then(function (res) {
            console.log("this is status info", res);
            if (res[0]['status'] == null) {
                _this.automatch(contactmodel);
            }
            else {
    ...
    InviteplacePage.prototype.automatch = function (contactmodel) {
        var _this = this;
        ...
        this.matchprovider.autoSavePlaceInfo(this.passdata, myid).then(function (res) {
            _this.matchprovider.autoSavePlaceInfo(_this.passdata, contactmodel['id']).then(function (ress) {
                _this.matchprovider.atuosaveMyplaceInfo(_this.passdata, myid).then(function (succ) {
                    _this.matchprovider.atuosaveMyplaceInfo(_this.passdata, contactmodel['id']).then(function (su) {
                        _this.matchprovider.autosaveMatchedUsers(contactmodel['id'], _this.passdata).then(function (su) {
                            _this.matchprovider.saveMatchedUsersList(contactmodel['id']).then(function (ss) {
                                _this.matchprovider.saveMatchedOtherUsersList(contactmodel['id']).then(function (succ) {
                                    _this.authprovider.getMyFriendsList(contactmodel['id']).then(function (resu) {
                                        _this.loading.dismiss();
                                        _this.notify('Sent');
                                    }).catch(function (e) {
                                        _this.authprovider.saveFriends("", contactmodel).then(function (suc) {
                                            _this.loading.dismiss();
                                            _this.notify('Sent');
                                        }).catch(function (err) {
    ...
    InviteplacePage.prototype.sendFriendRequestWithMatch = function (model) {
        var _this = this;
        this.authprovider.saveFriends(model.phoneNumbers, model).then(function (res) {
            _this.notify('Sent');
            _this.notifprovider.sendFriendRequest("Received Request! ", model['id'], " requested  to invite you out");
            _this.sendAutoMatchRquest(model);
        }).catch(function (err) {
            _this.loading.dismiss();
    ...
    InviteplacePage.prototype.sendTextMessage = function (phoneNumber) {
        var _this = this;
        var message = 'I’d like to invite you to ' + this.passdata['place_name'] + '. Accept the invite on Ditto http://dittochat.com/download';
        this.sms.sendTextMessages(phoneNumber, message).then(function (res) {
            _this.notify('Sent');
            _this.loading.dismiss();
        }).catch(function (er) {
            _this.loading.dismiss();
    ...
    InviteplacePage.prototype.checkUserHasApp = function (phonenumber) {
        if (this.usinguserarray.length != 0) {
            var status_3 = this.usinguserarray.filter(function (item) { return item['phoneNumbers'] === phonenumber; });
    ...
    InviteplacePage.prototype.getFriendsListInfo = function () {
        var _this = this;
        var myinfo = this.localstorageprovider.getUserinfo();
        // this.showLoading();
        this.authprovider
            .getMyFriendsList(myinfo.id)
            .then(function (result) {
            for (var i = 0; i < result.length; i++) {
                _this.authprovider.getFrindsInfoFromId(result[i]['userkey']).then(function (success) {
                    _this.friendArray.push(success[0]['phonenumber']);
                });
                if (i == result.length - 1) {
                    _this.getUsingAppUsersInfo();
                }
            }
        })
    ...
    InviteplacePage.prototype.getUsingAppUsersInfo = function () {
        var _this = this;
        this.matchprovider.getAllUsingUsersArray().then(function (suceess) {
            _this.onlineArray = [];
            _this.onlineTempArray = [];
            _this.phoneContactArray = [];
            _this.phoneContactTempArray = [];
            _this.otherListArray = [];
            _this.otherListTempArray = [];
            var onlinearray = [];
            var onlineTempArray = [];
            var otherlistarray = [];
            var otherlisttemparray = [];
            for (var i = 0; i < suceess.length; i++) {
                var contactmodel = new __WEBPACK_IMPORTED_MODULE_4__Model_ContactModel__["a" /* ContactModel */]();
                ...
                var array = _this.setInvitedUserStatus(suceess[i]['phonenumber']);
                if (array.length > 0) {
                    contactmodel.isInvited = true;
                    onlinearray.push(contactmodel);
                    onlineTempArray.push(contactmodel);
                ...
                // 
                _this.usinguserarray.push(contactmodel);
                if (i == suceess.length - 1) {
                    (_a = _this.otherListArray).push.apply(_a, otherlistarray.sort(_this.sortStrings));
                    (_b = _this.otherListTempArray).push.apply(_b, otherlisttemparray.sort(_this.sortStrings));
                    _this.getPhoneContactInfo(onlinearray, onlineTempArray);
                }
                _this.loading.dismiss();
            }
            var _a, _b;
    ...
    InviteplacePage.prototype.setInvitedUserStatus = function (number) {
        return this.friendArray.filter(function (elem) { return elem === number; });
    };
    ////////////// function : show progress view///////////////////
    InviteplacePage.prototype.showLoading = function () {
    ...
    InviteplacePage.prototype.notify = function (message) {
    ...
    InviteplacePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-inviteplace',template:/*ion-inline-start:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/inviteplace/inviteplace.html"*/'<!--\n  Generated template for the InviteplacePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-toolbar text-center>\n\n\n    <ion-title color="blackcolor" >\n     <p style="color: black; font-size: 20px;">Invite Friend</p> \n    </ion-title>\n\n    <ion-buttons right>\n      <button color="blackcolor" ion-button icon-only (click)="onclickDonebutton()">\n          Done\n      </button>\n    </ion-buttons>\n\n  </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content class="content">\n    <div class="top_image">\n      <img src="{{passdata.place_photo}}"/>\n      <div class="title">\n        <p>{{passdata.place_name}}</p>\n      </div>\n    </div>\n\n    <div *ngIf="searching" class="spinner-container">\n      <ion-spinner name="bubbles">Loading</ion-spinner>\n    </div>\n  \n    <!--searchbar -->\n    <ion-searchbar [(ngModel)]="searchTerm" [formControl]="searchControl" (ionInput)="onSearchInput()" class="searchbar" placeholder="Search by username...">\n  \n    </ion-searchbar>\n  \n    \n    <ion-item-group class="list">\n       \n      <ng-container *ngIf="searchTerm == \'\'">\n        <groupitem *ngIf="groupListArray.length > 0" [data]="groupListArray" [title]="\'Group\'" (onClickCheckBox)="onclickGroupCheckbox($event,\'group\')"></groupitem>\n      </ng-container>\n\n      <inviteitem *ngIf="onlineArray.length > 0" [data]="onlineArray" [title]="\'Online\'" (onClickCheckBox)="onclickCheckbox($event,\'online\')"></inviteitem>\n      <inviteitem *ngIf="phoneContactArray.length > 0" [data]="phoneContactArray" [title]="\'PhoneContact\'" (onClickCheckBox)="onclickCheckbox($event,\'phone\')"></inviteitem>\n\n      <ng-container *ngIf="searchTerm != \'\'">\n          <inviteitem [data]="otherListArray"  [title]="\'Other\'"  (onClickCheckBox)="onclickCheckbox($event,\'other\')"></inviteitem>\n      </ng-container>\n\n    </ion-item-group>   \n\n</ion-content>\n\n<ion-footer align="center" no-border>\n    <button class="botttom_button" (click)="onclickSendbutton()" ion-button>\n      Send\n    </button>\n</ion-footer>'/*ion-inline-end:"/Users/top_johnapple703/Documents/work/ionic/ditto/9_25/src/pages/inviteplace/inviteplace.html"*/,
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__providers_matched_matched__["a" /* MatchedProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_11__providers_sms_sms__["a" /* SmsProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_10__providers_group_group__["a" /* GroupProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* Events */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* ToastController */]])
    ], InviteplacePage);
    return InviteplacePage;
}());

//# sourceMappingURL=inviteplace.js.map
